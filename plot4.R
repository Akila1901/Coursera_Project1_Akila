...
par(mfrow=c(2,2))
with(get_datetime,{
  plot(get_datetime$Time,as.numeric(as.character(get_datetime$Global_active_power)),type="l",  xlab="",ylab="Global Active Power")  
  plot(get_datetime$Time,as.numeric(as.character(get_datetime$Voltage)), type="l",xlab="datetime",ylab="Voltage")
  ...
  plot(get_datetime$Time,as.numeric(as.character(get_datetime$Global_reactive_power)),type="l",xlab="datetime",ylab="Global_reactive_power")
})